...
_ESTIMATED_VEHICLE_LENGTH_M: Final[float] = 3.
_ESTIMATED_VEHICLE_WIDTH_M: Final[float] = 1.5
_ESTIMATED_CYCLIST_LENGTH_M: Final[float] = 1.
_ESTIMATED_CYCLIST_WIDTH_M: Final[float] = 0.3
_PLOT_BOUNDS_BUFFER_W: Final[float] = 50
_PLOT_BOUNDS_BUFFER_H: Final[float] = 25
...
def _plot_static_map_elements(
    ...
    for lane_segment in static_map.vector_lane_segments.values():
        ...
        # _plot_polylines(
        #     [centerline], line_width=1., color=_LANE_SEGMENT_COLOR, alpha=0.2, style="--"
        # )
        _plot_polylines(
            [centerline],
            line_width=1.5,
...
def _plot_actor_tracks(
    ...
    for track in scenario.tracks:
        ...
        track_color = _DEFAULT_ACTOR_COLOR
        # _scatter_polylines([history_trajectory], cmap="Blues", linewidth=2, arrow=False)

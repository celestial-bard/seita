...
class QCNet(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.minADE_1 = minADE(1)
        self.minFDE_1 = minFDE(1)
    ...
    def validation_step(self,
        ...
        self.minADE_1.update(pred=traj_eval[..., :self.output_dim], target=gt_eval[..., :self.output_dim], prob=pi_eval,
                             valid_mask=valid_mask_eval)
        self.minFDE_1.update(pred=traj_eval[..., :self.output_dim], target=gt_eval[..., :self.output_dim], prob=pi_eval,
                             valid_mask=valid_mask_eval)
